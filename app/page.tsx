  ...
  return (
    <>
      <div className="min-h-screen flex flex-col items-center p-6 bg-transparent text-black dark:text-white">
        ...
        <nav className="w-full max-w-5xl flex justify-between items-center p-4 mb-6 fixed top-5 z-40 bg-white dark:bg-zinc-950 border border-white/20 dark:border-black/20 rounded-lg shadow-lg">
