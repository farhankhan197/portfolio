...
export default function Home(): JSX.Element {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center p-6 bg-transparent text-black dark:text-white">
      ...
      >
        <p className="text-gray-600 dark:text-gray-400 m-2 p-4">
          Hey there, i'm
        </p>
      ...
      > 
        ...
        <button className="inline flex items-center gap-2 bg-green-100 dark:bg-green-800 text-green-800 dark:text-green-400 px-3 py-1 rounded-full text-sm font-medium hover:bg-green-200 dark:hover:bg-green-700 transition-colors whitespace-nowrap">
